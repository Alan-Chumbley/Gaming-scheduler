          ...
          <div>
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-sub uppercase">
                    {playerName}'s Schedule
                  </h3>
                </div>
                {/*body*/}
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-blueGray-500 text-lg leading-relaxed">
                    ...
                    Unde eaque praesentium et quas a aut, at laboriosam quo officia
                    sit! Cupiditate perspiciatis eligendi nobis! Expedita
                    repudiandae eos animi natus nam.
                  </p>
                </div>
                {/*footer*/}
